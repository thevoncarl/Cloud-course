...
instance = nova.servers.create(name="worker "+filename, image=image, flavor=flavor,key_name = keypair.name, userdata=userdata, nics=nics,security_groups=secgroups)
