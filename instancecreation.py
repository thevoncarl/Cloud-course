...
keypair = nova.keypairs.create('viktor_kp',publickey)
f.close()

print "Creating instance ... "
instance = nova.servers.create(name="viktor_vm1", image=image, flavor=flavor, nics=nics,security_groups=secgroups, key_name = keypair.name)
